...
**Current phase:** Phase 3 — Voice. Spike (PR #6), B1 plumbing (PR #7), B2 React/UI (PR #8), and B3a cleanup (PR #15) merged. B3b (full rate limiter + ADR) and the remaining B3 exit-criteria are the next chunk — start at `03-voice.md` "Phase 3 progress".
