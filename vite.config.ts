      ...
      alias: {
        ...(isNative
          ? {
              ...
              // Native system bars follow the resolved appearance via @capacitor/status-bar and the
              // in-app NavigationBar plugin; swap the seam so neither reaches the web bundle
              // (dark mode, #154).
