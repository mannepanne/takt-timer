// ABOUT: Typed React icon set ported from the prototype's icons.jsx.
// ABOUT: 1.6px stroke weight, size and colour tunable per instance.
...
export const Icon = {
  Mic: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Play: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
      <path d="M7 4.5v15l13-7.5z" />
    </svg>
  ),
  Pause: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
      <rect x="6" y="4" width="4" height="16" rx="1" />
      <rect x="14" y="4" width="4" height="16" rx="1" />
    </svg>
  ),
  Stop: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
      <rect x="6" y="6" width="12" height="12" rx="2" />
    </svg>
  ),
  Skip: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  SkipBack: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  List: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  ChevronLeft: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  ChevronRight: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Volume: ({ size = 20, color = 'currentColor' }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Star: ({ size = 18, color = 'currentColor', filled = false }: StarProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Grip: ({ size = 18, color = 'currentColor' }: IconProps) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
  ...
  User: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Question: ({ size = 22, color = 'currentColor' }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
