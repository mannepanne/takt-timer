...
If the upstream `Write`-matcher defect is fixed _and_ you want the hook to also cover `Edit`/`MultiEdit` for some reason, the registration needs adjusting:
