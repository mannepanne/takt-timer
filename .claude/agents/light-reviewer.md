...
- **Temporal language in docs** — "recently added", "was changed to", "we now…", "previously…", "just updated". Project style is evergreen prose describing the code _as it is_, not how it evolved. Flag each occurrence.
